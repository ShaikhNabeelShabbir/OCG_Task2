        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, JSON_File_Creator(JData, name)];
                case 4:
                    _a.sent();
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchDATA("https://api.coingecko.com/api/v3/simple/supported_vs_currencies", "supported_vs_currencies")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, firstTen("supported_vs_currencies.json")];
                case 2:
                    top10 = _a.sent();
                    return [4 /*yield*/, fetchDATA("https://api.coingecko.com/api/v3/exchange_rates", "coingecko_vs_currencies")];
                case 3:
                    _a.sent();
                    parsingJSON(top10);
                    return [2 /*return*/];
